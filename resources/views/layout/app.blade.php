...
<head>
        ...
        <nav class="bg-white py-2 md:py-4">
            <div class="container px-4 mx-auto md:flex md:items-center">
                ...
                <div class="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
                    ...
                    <a href="/categorias"
                        class="p-2 lg:px-4 md:mx-2 text-indigo-600 text-center border border-transparent rounded hover:bg-indigo-100 hover:text-indigo-700 transition-colors duration-300">Categorias</a>
                </div>
            </div>
        </nav>
    ...
    <div class="corpo right-0 left-0 pt-7 md:pt-10">
        ...
        <div class="flex justify-center items-center overflow-hidden my-8 bg-slate-100">
            @section('titulos')
            @show
        </div>
            ...
            <div class="sm:flex sm:flex-wrap sm:-mx-4 mt-6 pt-6 sm:mt-12 sm:pt-12 border-t">
                ...
                <div class="px-4 md:w-1/4 md:ml-auto mt-6 sm:mt-4 md:mt-0">
                    <a href="/produtos/create"
                        class="px-4 py-2 bg-purple-800 hover:bg-purple-900 rounded text-white">Get Started</a>
                </div>
            </div>
        </div>
    </footer>
