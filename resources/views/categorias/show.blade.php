...
<div class="rounded-md w-1/2 bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 py-5">
    <table class="w-full table-auto ">
        ...
        <tbody>
            <tr>
                ...
                <td class="border-b border-slate-100 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">{{$categoria->id}}</td>
            </tr>
    ...
    <div class="flex justify-center mt-5">
        <a class="bg-yellow-500 hover:bg-black hover:text-white text-white font-bold mx-1 py-2 px-4 rounded focus:outline-none focus:shadow-outline" href="{{route('categorias.edit', ['categoria' => $categoria])}}"> Editar</a>
